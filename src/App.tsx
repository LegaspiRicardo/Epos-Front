...
function App() {
  return (
    <>
      <div className='bg-cyan-950 py-5 text-white'>
      ...
      <div className='bg-slate-50 pt-16 text-center'>
        ...
        <p className='py-16'>Escribanos</p>
        ...
        <form action="" className='text-sm'>
          <div className='w-11/12 mx-auto  flex'>
            <div className=' w-3/6 text-start'>
              ...
              <input type="email" className='bg-white border w-11/12 rounded-md py-1' />
            </div>
            <div className=' w-3/6 text-start'>
              <label htmlFor="telefono" className='text-xs'>Telefono </label>
              <input type="number" className='bg-white border w-11/12 rounded-md py-1' placeholder='' />
            </div>
          </div>
          <div className=' w-11/12 mx-auto text-start mt-4 mb-8'>
            <label htmlFor="mensaje" className='text-xs'>Mensaje </label>
            <input type="text" className='bg-white border w-full rounded-md py-4' placeholder='' />
          </div>
          <div className='w-11/12 mx-auto'> 
            <button type='submit' className='bg-gray-400 rounded text-white w-2/6 ml-40 px-6 py-1'>Enviar</button>
          </div>
        </form>
