...
const Productos = () => {
  ...
  return (
    <div>
      <section className="w-11/12 mx-auto mt-8 pb-32">
        {/* Header con título y controles */}
        <div className="lg:w-full md:w-11/12 w-9/12 mx-auto mt-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
            ...
            <div className="flex items-center space-x-4">
              <button className="bg-cyan-950 text-white hover:bg-cyan-800  px-2 rounded-full transition-colors shadow-sm flex items-center gap-2">
                <span className="text-2xl text-white mb-1 hover:text-white">
                  +
                </span>
              </button>
        ...
        <table className="w-full border border-gray-500">
          <thead className="bg-cyan-900 text-white border border-gray-500 h-10 text-xs lg:text-md xl:text-base">
            <tr>
              <th
                scope="col"
                className="border border-gray-500 bg-gray-700 px-2 py-1"
              >
          ...
          <tbody className="text-center text-xs lg:text-md xl:text-base border border-gray-500">
            {currentItems.map((producto) => (
              ...
              >
                ...
                <td className="border border-gray-500 md:text-center text-justify">
                ...
                <td className="border border-gray-500">
                  <span
                    className={`badge p-1 rounded-xl ${getBadgeClass(
                      producto.status
                    )}`}
                  >
