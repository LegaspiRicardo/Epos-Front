        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="w-11/12 mx-auto py-4">
                <nav className="flex text-sm text-gray-600">
                    <Link to="/" className="hover:text-cyan-700 transition-colors">Inicio</Link>
                    <span className="mx-2">/</span>
                    <Link to="/tienda" className="hover:text-cyan-700 transition-colors">Tienda</Link>
                    <span className="mx-2">/</span>
                    <Link to={`/categoria/${producto.categoria?.id}`} className="hover:text-cyan-700 transition-colors">
            ...
            <div className="w-full hidden lg:block mb-16 py-8">
                <div className="flex flex-wrap">
                    <div className="my-6 w-11/12 mx-auto px-2 flex rounded-xl py-8 bg-white shadow-sm border border-gray-200">
                            ...
                            <div className="w-11/12 mx-auto">
                                ...
                                <div className="w-full mt-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {producto.acabado && (
                                                <p className="text-lg text-gray-600 mb-2">
                                                    <span className="font-semibold">Acabado:</span> {producto.acabado.nombre}
                                                </p>
                                            )}
                                            {producto.categoria && (
                                                <p className="text-lg text-gray-600 mb-2">
                                    ...
                                    <div className="mt-6 w-11/12 mx-auto">
                                        <p className="text-3xl font-bold text-cyan-800">${producto.precio}.00 MXN</p>
                        ...
                        <div className="w-6/12 pl-8 border-l border-gray-200">
                            {producto.especificacion && (
                                <section className="p-4">
                                    <h2 className="font-bold mb-6 text-2xl text-gray-900">Especificaciones Técnicas</h2>
                                                ...
                                                {(() => {
                                                    ...
                                                    return Object.entries(allSpecs).map(([key, value], index) => {
                                                        ...
                                                        return (
                                                            <tr
                                                                key={key}
                                                                className={`${index % 2 === 0 ? "bg-gray-50" : "bg-white"} border-b border-gray-200 last:border-b-0`}
                                                            >
            ...
            <div className="w-11/12 mx-auto lg:hidden">
                <div className="my-6 w-full rounded-xl bg-white shadow-sm border border-gray-200 overflow-hidden">
                    {/* Título */}
                    ...
                    <div className="p-6 border-b border-gray-200">
                        <div className="flex justify-between items-center">
                            <div>
                                <p className="text-3xl font-bold text-cyan-800">${producto.precio}.00</p>
                    ...
                    {producto.especificacion && (
                        <div className="p-6">
                            <h2 className="font-bold mb-4 text-xl text-gray-900">Especificaciones</h2>
