...
function HomePage() {
  return (
    <>
      ...
      <div
        className="min-h-screen pb-12 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/images/fondotornillos.jpg')" }}
      >
        <div className="w-11/12 mx-auto pt-24">
          <AnimatedSection delay={0.2} direction="down">
            <img
              src="/logotipoepos.png"
              alt=""
              className="bg-white/60 rounded-xl mx-auto"
            />
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.4} direction="up">
            <div className="bg-white/70 bg-opacity-90 p-8 rounded-lg max-w-2xl mx-auto mt-12">
              <p className="text-justify mb-8 text-gray-800 text-lg leading-relaxed font-semibold">
                Somos una empresa mexicana dedicada a la distribución y
                comercialización de refacciones automotrices, especializados en
                tornillería, birlos, muelles, entre otros
              </p>
              <div className="bg-cyan-950 text-white py-8 rounded-lg">
                <p className="text-center font-semibold italic text-xl mx-auto w-11/12">
                  "Te entregamos justo lo que necesitas, cuando más lo
                  necesitas."
                </p>
              </div>
            </div>
      ...
      <AnimatedSection delay={0.2} direction="up">
        <div className="mt-16 mb-24">
          <div className="w-11/12 mx-auto">
            ...
            <p className="mb-8 mt-2 text-xl">
              Refacciones industriales de{" "}
              <span className="text-cyan-800 font-bold"> alta calidad</span>
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
              {[
                {
                  href: "/categorias",
                  icon: "/icons/birlo.png",
                  name: "Birlos",
                },
                {
                  href: "/categorias",
                  icon: "/icons/tornillo.png",
                  name: "Tornillos",
                },
                ...
                {
                  href: "/categorias",
                  icon: "/icons/pijas.png",
                  name: "Pijas",
                },
                {
                  href: "/categorias",
                  icon: "/icons/tuerca.png",
                  name: "Tuercas",
                },
              ].map((product, index) => (
                <AnimatedSection
        ...
        <div className="relative bg-cyan-900 pt-14 pb-24 overflow-hidden">
          ...
          <div className="relative z-10 w-11/12 mx-auto">
            ...
            <p className="mb-6 text-xl text-white">
              Refacciones para cada necesidad
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  title: "Kit Básico para Talleres",
                  desc: "Incluye refacciones esenciales para el mantenimiento diario de talleres mecánicos.",
                },
                {
                  title: "Kit Preventivo para Flotillas",
                  desc: "Diseñado para el mantenimiento preventivo de vehículos pesados y flotillas.",
                },
                {
                  title: "Kit de Refacciones Urgentes",
                  desc: "Componentes para reparaciones urgentes y minimizar tiempos muertos.",
                },
              ].map((kit, index) => (
                <AnimatedSection
                  key={kit.title}
                  ...
                  direction="up"
                >
                  <div className="bg-white border rounded-lg p-6 shadow-lg h-48 md:h-56">
                    <div className="m-0 ">
                      <p className="font-bold mb-2 text-xl md:h-16">
                        {kit.title}
                      </p>
      ...
      <AnimatedSection delay={0.3} direction="right">
        <div className="mt-16 bg-cyan-950 text-white py-12">
          <div className="w-11/12 mx-auto mb-8">
            <p className="font-bold text-2xl mb-2 ">¿Cómo trabajamos?</p>
              ...
              <ol className="list-decimal list-inside text-sm space-y-4 text-justify w-11/12 mx-auto">
                {[
                  ...
                  <AnimatedSection
                    ...
                    direction="right"
                  >
                    <li className="text-lg py-2 bg-cyan-900 rounded-lg p-4">
                      {step}
                    </li>
                  </AnimatedSection>
                ))}
        ...
        <div className="py-16 w-11/12 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <AnimatedSection delay={0.3} direction="left">
              <div className="bg-white border-l-4 border-cyan-600 shadow-md p-6 max-h-42 rounded-lg hover:shadow-lg transition-shadow">
                <div className="flex items-start">
                  <div className="bg-cyan-100 p-3 rounded-full mr-6 ">
                    <span className="text-cyan-600 font-bold">
                      <img
                        src="/icons/mecanico.png"
                        className="w-32 md:max-w-16"
                        alt=""
                      />
                    </span>
                  </div>
                  <p className="text-gray-700 text-lg">
                    Talleres mecánicos, refaccionarias, empresas de transporte
                  </p>
                </div>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.4} direction="right">
              <div className="bg-white border-l-4 border-green-600 shadow-md p-6 max-h-42 rounded-lg hover:shadow-lg transition-shadow">
                <div className="flex items-start">
                  ...
                  <p className="text-gray-700 text-lg 0 ">
                    Clientes individuales con envíos a todo el país
                  </p>
                </div>
              </div>
            </AnimatedSection>
          ...
          <form action="" className="text-sm">
            <div className="w-11/12 mx-auto flex flex-col md:flex-row gap-4">
              <AnimatedSection
                delay={0.4}
                direction="left"
                className="w-full md:w-3/6 text-start"
              >
                <div>
            ...
            <AnimatedSection
              delay={0.6}
              direction="up"
              className="w-11/12 mx-auto text-start mt-4 mb-4"
            >
              <div>
